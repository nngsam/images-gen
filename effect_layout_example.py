...
def base_cfg(name: str):
    return GeneratorCfg(
        ...
        render_cfg=RenderCfg(
            ...
            corpus=WordCorpus(
                WordCorpusCfg(
                text_paths=[TEXT_DIR / "example.txt"],
                filter_by_chars=True,
                chars_file=CHAR_DIR / "vocab_vi.txt",
                **font_cfg
                ),
            ),
        ),
...
configs = [
    ...
    emboss(),
    vertical_text(),
    #extra_text_line_layout(), -> ra tieng anh, sua config bi loi
    ...
    dropout_vertical(),
    padding(),
    #same_line_layout_different_font_size(), -> Ra tieng an 
]
